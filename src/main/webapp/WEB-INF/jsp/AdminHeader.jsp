<header class="company px-4 py-2 3text-sm leading">
	<div class="flex items-center justify-between">
		<ul class="menu">
			<li class="menu-item"><img
				src="${pageContext.request.contextPath}/img/ht-logo.jpeg"
				alt="Housing Trio Logo"></li>

			<li class="menu-item"><a
				href="${pageContext.request.contextPath}/admin/approve-properties">Approve
					Properties</a></li>
